...
struct kex_testcase kex_testcases[] = {
    ...
    { OQS_KEX_alg_lwe_okcn, (unsigned char *) "01234567890123456", 16, "recommended", "lwe_okcn_recommended", 0 },
    { OQS_KEX_alg_lwr_okcn, (unsigned char *) "01234567890123456", 16, "recommended", "lwr_okcn_recommended", 0 },
};
